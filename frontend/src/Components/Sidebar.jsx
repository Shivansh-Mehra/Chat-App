...
export default function Sidebar() {
  ...
  return (
    <aside className="h-full flex flex-col w-full sm:w-64 lg:w-72 border-r border-gray-200 transition-all duration-200">      <div className="border-b border-base-300 w-full p-5">
        ...
        <div className="mt-2 mb-2 flex items-center gap-2">
          <input
            ...
            className="mr-2"
          />
          <label htmlFor="grp" className="flex items-center">
            Show groups only
          </label>
        </div>
        ...
        <div className="overflow-y-auto h-96 w-full">
          {showGroups ? (
            groups.map((group) => (
              ...
              >
                <img
                  ...
                  alt="profile pic"
                  className="border rounded-full w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12"
                />
            ...
            filteredUsers.map((user) => (
              ...
              >
                <img
                  src={user.profilePic && user.profilePic.url !== "" ? user.profilePic.url : defaultProfilePic}
                  alt="profile pic"
                  className="border rounded-full w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12"
                />
