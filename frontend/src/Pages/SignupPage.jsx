...
export default function SignupPage() {
    ...
    return (
        <div className='min-h-screen grid lg:grid-cols-2'>
            <div className='flex items-center justify-center flex-col p-6 sm:p-12'>
                <div className='w-full max-w-md space-y-8'>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-6'>
                        ...
                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full" disabled={isSigningUp}>
                            {isSigningUp ? (
                                <>
            ...
            <AuthImagePattern 
                title="Join Us!"
                subtitle="Join us and chat with your friends and family"
            />
        </div>
    )
}